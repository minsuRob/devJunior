...
/* Java 와 C++ 등은 프로퍼티를 갖는 객체를 여러 개 생성하는 수단으로 클래스(class)를 제공한다. 클래스는 붕어빵 틀에 비유할 수 있다. 붕어빵 틀을 사용하면 모양이 같은 붕어빵을 얼마든지 만들 수 있다. 붕어빵 틀과 마찬가지로 클래스를 사용하면 프로퍼티가 똑같은 객체를 얼마든지 만들 수 있다. */ \;
